...
export const UserTransactionsDetails = (props) => {
  ...
  const inputImageHandler = (e) => {
    if(e.target.files[0]){
        setInputImage({imageName: e.target.files[0].name, image_userpayment: e.target.files[0] });
        }
}
...
const addImgPayment = () => {
    ...
    formData.append('file', inputImage.image_userpayment)
...
export default UserTransactionsDetails;